...
import { HUD_TAB_ORDER, labelForNodeId } from "@/lib/mapData";
import { TOP_BAR_TOP, TOP_DOCK_SHELL } from "@/lib/navDock";

type HudTabNodeId = (typeof HUD_TAB_ORDER)[number]["nodeId"];
...
export function HUDTabs({ activeNodeId, onSelect }: HUDTabsProps) {
  return (
    <motion.nav
      ...
      aria-label="Navegación rápida del mapa"
    >
      <div
