...
const ES_COPY: Omit<PageCopy, "locale" | "htmlLangAttr"> = {
  seo: {
    title: "Jancarlo Gallón Cano | Software Engineer & Full Stack Developer",
    description:
      "Portafolio profesional de Jancarlo Gallón Cano: Software Engineer y Desarrollador Full Stack especializado en Next.js, React, .NET (C#), Python y SQL Server. Proyectos de software, experiencia en producción y formación en ingeniería desde Pereira, Colombia.",
    keywords: [
    ...
    ogLocale: "es_CO",
    siteName: "Jancarlo Gallón Cano · Software Engineer",
    ogTagline: "Software Engineer | Next.js, React, .NET, Python & Cloud",
  },
  hackerConsole: {
...
const EN_COPY: Omit<PageCopy, "locale" | "htmlLangAttr"> = {
  seo: {
    title: "Jancarlo Gallón Cano | Software Engineer & Full Stack Developer",
    description:
      "Professional portfolio of Jancarlo Gallón Cano: Software Engineer and Full Stack Developer specializing in Next.js, React, .NET (C#), Python, and SQL Server. Shipped projects, production experience, and engineering background based in Pereira, Colombia.",
    keywords: [
      "Jancarlo Gallón Cano",
      "Jancarlo Gallon",
      "Software Engineer",
